...
public class WaiterRepository {
    ...
    private void populateInitialTables() {
    ...
    public LiveData<List<MenuItem>> getMenuItems(String type, String section) {
        return menuItemDao.getByTypeAndSection(type, section);
    }
    ...
    public void updateGuestCount(long orderId, int count) {
        executor.execute(() -> { try { orderDao.updateGuestCount(orderId, count); } catch (Exception e) { Log.e("Repo", "updateGuestCount", e); } });
    }

    public void updateGuestNames(long orderId, String names) {
        executor.execute(() -> { try { orderDao.updateGuestNames(orderId, names); } catch (Exception e) { Log.e("Repo", "updateGuestNames", e); } });
    }

    public void updateTableNotes(long orderId, String notes) {
        executor.execute(() -> { try { orderDao.updateTableNotes(orderId, notes); } catch (Exception e) { Log.e("Repo", "updateTableNotes", e); } });
    }

    public void deleteOrder(long orderId) {
        executor.execute(() -> { try { orderDao.deleteById(orderId); } catch (Exception e) { Log.e("Repo", "deleteOrder", e); } });
    }
    ...
    public void addItemToOrder(long orderId, MenuItem menuItem, int qty, String comment, int guestNumber) {
        executor.execute(() -> {
            try {
                OrderItem item = new OrderItem(orderId, menuItem, qty, comment, guestNumber);
    ...
    public void updateOrderItemComment(long itemId, String comment) {
        executor.execute(() -> { try { orderItemDao.updateComment(itemId, comment); } catch (Exception e) { Log.e("Repo", "updateComment", e); } });
    }

    public void updateServedStatus(long itemId, boolean served) {
        executor.execute(() -> { try { orderItemDao.updateServedStatus(itemId, served); } catch (Exception e) { Log.e("Repo", "updateServed", e); } });
    }

    public void deleteOrderItem(long itemId) {
        executor.execute(() -> { try { orderItemDao.deleteById(itemId); } catch (Exception e) { Log.e("Repo", "deleteItem", e); } });
    }
